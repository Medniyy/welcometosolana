import{C as e,Q as t,R as n,Y as r,q as i,y as a}from"./ApiController-BDRU9EIo.js";import{C as o,_ as s,b as c,g as l,o as u,p as d,v as f}from"./wui-text-Cs9tULlT.js";import"./wui-icon-DMlBfY1S.js";var p=r({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=n({state:p,subscribe(e){return t(p,()=>e(p))},subscribeKey(e,t){return i(p,e,t)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=o`
  :host {
    width: 100%;
    display: block;
  }
