import{C as e,P as t,U as n,V as r,dt as i,h as a,r as o,x as s,y as c}from"./ApiController-BDRU9EIo.js";import{_ as l,b as u,c as d,g as f,o as p,p as m,u as h,v as g}from"./wui-text-Cs9tULlT.js";import{t as _}from"./SwapController-KoIIw2s9.js";import"./w3m-tooltip-DGApP6EV.js";import{t as v}from"./MathUtil-B2UslVSw.js";import"./wui-button-CeUJRxhF.js";import"./wui-icon-DMlBfY1S.js";import"./wui-image-Gbq4Ffas.js";import"./wui-shimmer-pHLoYRC-.js";import"./wui-shimmer-BW8rwYWm.js";import"./wui-icon-box-IX9JJhld.js";import"./wui-input-text-C9tWPfFr.js";import"./wui-token-button-sCRDid38.js";var y={numericInputKeyDown(e,t,n){let r=[`Backspace`,`Meta`,`Ctrl`,`a`,`A`,`c`,`C`,`x`,`X`,`v`,`V`,`ArrowLeft`,`ArrowRight`,`Tab`],i=e.metaKey||e.ctrlKey,a=e.key,o=a.toLocaleLowerCase(),s=o===`a`,c=o===`c`,l=o===`v`,u=o===`x`,d=a===`,`,f=a===`.`,p=a>=`0`&&a<=`9`;!i&&(s||c||l||u)&&e.preventDefault(),t===`0`&&!d&&!f&&a===`0`&&e.preventDefault(),t===`0`&&p&&(n(a),e.preventDefault()),(d||f)&&(t||(n(`0.`),e.preventDefault()),(t?.includes(`.`)||t?.includes(`,`))&&e.preventDefault()),!p&&!r.includes(a)&&!f&&!d&&e.preventDefault()}},b=m`
  :host {
    width: 100%;
  }
