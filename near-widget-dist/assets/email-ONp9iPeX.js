import{C as e,D as t,V as n,_ as r,l as i,pt as a,r as o,x as s,y as c,z as l}from"./ApiController-BDRU9EIo.js";import{C as u,b as d,g as f,o as p,p as m,v as h}from"./wui-text-Cs9tULlT.js";import"./wui-button-CeUJRxhF.js";import{t as g}from"./ConstantsUtil-BbB_U3vl.js";import"./wui-link-Dj0WiESb.js";import{t as _}from"./w3m-email-otp-widget-DG9KoUmc.js";import"./wui-icon-box-IX9JJhld.js";import{n as v,t as y}from"./ref-CZPlOA1I.js";import"./wui-email-input-BZ-seBvI.js";var b=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},x=class extends _{constructor(){super(...arguments),this.onOtpSubmit=async r=>{try{if(this.authConnector){let n=o.state.activeChain,a=i.getConnections(n),u=l.state.remoteFeatures?.multiWallet,d=a.length>0;if(await this.authConnector.provider.connectOtp({otp:r}),s.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_PASS`}),n)await i.connectExternal(this.authConnector,n);else throw Error(`Active chain is not set on ChainController`);if(l.state.remoteFeatures?.emailCapture)return;if(l.state.siwx){c.close();return}if(d&&u){e.replace(`ProfileWallets`),t.showSuccess(`New Wallet Added`);return}c.close()}}catch(e){throw s.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_FAIL`,properties:{message:n.parseError(e)}}),e}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),s.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_SENT`}))}}};x=b([p(`w3m-email-verify-otp-view`)],x);var S=m`
  wui-icon-box {
