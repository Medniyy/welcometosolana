import{C as e,D as t,F as n,L as r,U as i,V as a,at as o,c as s,dt as c,i as l,l as u,r as d,x as f,y as p}from"./ApiController-BDRU9EIo.js";import{_ as m,b as h,c as g,g as _,h as v,o as y,p as b,s as x,u as S,v as C}from"./wui-text-Cs9tULlT.js";import{t as w}from"./SwapController-KoIIw2s9.js";import"./wui-button-CeUJRxhF.js";import"./wui-icon-DMlBfY1S.js";import"./wui-image-Gbq4Ffas.js";import"./wui-separator-BP0QF4RC.js";import"./wui-link-Dj0WiESb.js";import"./wui-icon-box-IX9JJhld.js";import{n as T,t as E}from"./ref-CZPlOA1I.js";import"./wui-avatar-DZIEG5jq.js";import"./wui-list-token-BzRb9ezR.js";import"./wui-input-text-C9tWPfFr.js";import"./wui-input-amount-H9LNKSVX.js";import"./wui-token-button-sCRDid38.js";var D=b`
  :host {
    width: 100%;
    height: 100px;
...
`,j=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},M=class extends C{constructor(){super(...arguments),this.readOnly=!1,this.isInsufficientBalance=!1}render(){let e=this.readOnly||!this.token;return h` <wui-flex
    ...
    </wui-flex>`}onInputChange(e){l.setTokenAmount(String(e.detail))}onMaxClick(){if(this.token){let e=Number(this.token.quantity.decimals),t=c.bigNumber(this.token.quantity.numeric);if(!this.token.address&&this.gasPrice){let n=65000n*BigInt(this.gasPrice),r=c.bigNumber(n.toString()).div(c.bigNumber(10).pow(e)),i=t.minus(r);l.setTokenAmount(i.gt(0)?i.toFixed(e,0):`0`)}else l.setTokenAmount(t.toFixed(e,0))}}};M.styles=A,j([m({type:Object})],M.prototype,`token`,void 0),j([m({type:Boolean})],M.prototype,`readOnly`,void 0),j([m({type:String})],M.prototype,`sendTokenAmount`,void 0),j([m({type:Boolean})],M.prototype,`isInsufficientBalance`,void 0),j([m({type:String})],M.prototype,`gasPrice`,void 0),M=j([y(`w3m-input-token`)],M);var N=b`
  :host {
    display: block;
  }
